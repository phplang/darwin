...
PHP_DARWIN_STR(kSecUseKeychain)
...
PHP_DARWIN_STR(kSecAttrAccess)
PHP_DARWIN_STR(kSecAttrAccessControl)
PHP_DARWIN_STR(kSecAttrAccessible)
PHP_DARWIN_STR(kSecAttrAccessGroup)
PHP_DARWIN_STR(kSecAttrSynchronizable)
PHP_DARWIN_STR(kSecAttrCreationDate)
PHP_DARWIN_STR(kSecAttrModificationDate)
PHP_DARWIN_STR(kSecAttrDescription)
PHP_DARWIN_STR(kSecAttrComment)
PHP_DARWIN_STR(kSecAttrCreator)
PHP_DARWIN_STR(kSecAttrType)
PHP_DARWIN_STR(kSecAttrLabel)
PHP_DARWIN_STR(kSecAttrIsInvisible)
PHP_DARWIN_STR(kSecAttrIsNegative)
PHP_DARWIN_STR(kSecAttrSyncViewHint)
PHP_DARWIN_STR(kSecAttrAccount)
PHP_DARWIN_STR(kSecAttrService)
PHP_DARWIN_STR(kSecAttrGeneric)
PHP_DARWIN_STR(kSecAttrSecurityDomain)
PHP_DARWIN_STR(kSecAttrServer)
PHP_DARWIN_STR(kSecAttrProtocol)
PHP_DARWIN_STR(kSecAttrAuthenticationType)
PHP_DARWIN_STR(kSecAttrPort)
PHP_DARWIN_STR(kSecAttrPath)
PHP_DARWIN_STR(kSecAttrSubject)
PHP_DARWIN_STR(kSecAttrIssuer)
PHP_DARWIN_STR(kSecAttrSerialNumber)
PHP_DARWIN_STR(kSecAttrSubjectKeyID)
PHP_DARWIN_STR(kSecAttrPublicKeyHash)
PHP_DARWIN_STR(kSecAttrCertificateType)
PHP_DARWIN_STR(kSecAttrCertificateEncoding)
PHP_DARWIN_STR(kSecAttrKeyClass)
PHP_DARWIN_STR(kSecAttrApplicationLabel)
PHP_DARWIN_STR(kSecAttrApplicationTag)
PHP_DARWIN_STR(kSecAttrKeyType)
PHP_DARWIN_STR(kSecAttrPRF)
PHP_DARWIN_STR(kSecAttrSalt)
PHP_DARWIN_STR(kSecAttrRounds)
PHP_DARWIN_STR(kSecAttrKeySizeInBits)
PHP_DARWIN_STR(kSecAttrEffectiveKeySize)
PHP_DARWIN_STR(kSecAttrTokenID)
PHP_DARWIN_STR(kSecAttrIsPermanent)
PHP_DARWIN_STR(kSecAttrIsSensitive)
PHP_DARWIN_STR(kSecAttrIsExtractable)
PHP_DARWIN_STR(kSecAttrCanEncrypt)
PHP_DARWIN_STR(kSecAttrCanDecrypt)
PHP_DARWIN_STR(kSecAttrCanDerive)
PHP_DARWIN_STR(kSecAttrCanSign)
PHP_DARWIN_STR(kSecAttrCanVerify)
PHP_DARWIN_STR(kSecAttrCanWrap)
PHP_DARWIN_STR(kSecAttrCanUnwrap)
